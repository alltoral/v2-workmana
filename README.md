...
Pronto. A primeira pessoa que abrir o link cria os dados iniciais no Firestore automaticamente (equipe de exemplo + tarefas de exemplo); todo mundo que entrar depois já vê os dados reais da equipe, sincronizados em tempo real.
